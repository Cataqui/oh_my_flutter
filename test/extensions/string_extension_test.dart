...
void main() {
  group('StringExtension', () {
    test(
      'when parsing #RRGGBB, it should return a Color with full opacity',
      () {
    ...
    test(
      'when parsing RRGGBB without hash, it should return a Color with full opacity',
      () {
        final color = 'F4F2EF'.hexToColor();
    ...
    test(
      'when parsing an invalid hex string, it should throw a FormatException',
      () {
