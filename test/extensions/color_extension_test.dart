...
void main() {
  group('ColorExtension', () {
    test(
      'when lightening a color, it should lerp the color toward white by the provided amount',
      () {
        final color = const Color(0xFFB3B3B3).lighten(0.6);

        expect(
          color,
          equals(Color.lerp(const Color(0xFFB3B3B3), Colors.white, 0.6)),
        );
      },
    );

    test(
      'when lightening by less than zero, it should clamp to the original color',
      () {
    ...
    test(
      'when darkening a color, it should lerp the color toward black by the provided amount',
      () {
        final color = const Color(0xFFE1E1E1).darken(0.28);

        expect(
          color,
          equals(Color.lerp(const Color(0xFFE1E1E1), Colors.black, 0.28)),
        );
      },
    );

    test(
      'when darkening by less than zero, it should clamp to the original color',
      () {
    ...
    group('toOklch', () {
      test(
        'when calling toOklch on #FF4A4B, it should produce the correct OKLCH values',
        () {
      ...
      test(
        'when calling toOklch on #0090FF, it should produce the correct OKLCH values',
        () {
      ...
      test(
        'when calling toOklch on #00D757, it should produce the correct OKLCH values',
        () {
      ...
      test(
        'when calling toOklch on #000000, it should produce zero lightness and chroma',
        () {
      ...
      test(
        'when calling toOklch on #FFFFFF, it should produce full lightness and zero chroma',
        () {
      ...
      test(
        'when calling toOklch on #808080, it should produce near-zero chroma',
        () {
      ...
      test(
        'when calling toOklch on #FF0000, it should produce a red hue near 25',
        () {
      ...
      test(
        'when calling toOklch on #00FF00, it should produce a green hue near 140',
        () {
      ...
      test(
        'when calling toOklch on #0000FF, it should produce a blue hue near 265',
        () {
      ...
      test(
        'when calling toOklch on a color, it should return the same as Oklch.fromColor',
        () {
